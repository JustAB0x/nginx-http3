...
#
curl --silent --location https://github.com/openresty/set-misc-nginx-module/archive/refs/tags/${MODULE_NGINX_MISC}.tar.gz | gtar xz -C /usr/src --one-top-level=set-misc-nginx-module --strip-components=1 || exit 1
